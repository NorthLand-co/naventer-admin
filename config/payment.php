    ...
    */
    'drivers' => [
        ...
        'nextpay' => [
            ...
            'merchantId' => env('NEXT_PAY_MERCHANT_ID'),
            'callbackUrl' => env('NEXT_PAY_CALLBACK'),
        ...
        'zarinpal' => [
            ...
            'apiInquiryUrl' => 'https://api.zarinpal.com/pg/v4/payment/inquiry.json',
            ...
            'callbackUrl' => env('ZARINPAL_CALLBACK'),
        ...
        'zibal' => [
            ...
            'apiInquiryUrl' => 'https://gateway.zibal.ir/v1/inquiry',

            'mode' => 'direct', // can be normal, direct

            'merchantId' => env('ZIBAL_MERCHANT_ID'),
            'callbackUrl' => env('ZIBAL_CALLBACK'),
